...
public class kuaidiDemo {
    public static final String DEF_CHATSET = "UTF-8";
    public static final int DEF_CONN_TIMEOUT = 30000;
    public static final int DEF_READ_TIMEOUT = 30000;
    public static final  Gson mGson = new Gson();
    public static ListBean mListBean;
    public static ListBean1 mListBean1;
    ...
    public static void getRequest1(String com,String no){
        ...
        try{
            ...
            mListBean1 = mGson.fromJson(result,ListBean1.class);
    ...
    public static void getRequest2() {
        ...
        try{
            result =net(url, params, "GET");
            mListBean = mGson.fromJson(result,ListBean.class);
    ...
    public static ListBean1 getListBean1(){
        return mListBean1;
    }
